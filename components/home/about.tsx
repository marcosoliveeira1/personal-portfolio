...
export function About() {
    ...
    return (
        ...
        <div id="about" className="bg-sky-700 px-0 pt-20 lg:pb-[120px] text-[rgba(255,255,255,.8)] min-h-[800px]">
            <div className="container h-auto max-w-[1200px] my-0 grid lg:grid-cols-2 gap-10 lg:gap-20 p-10">
                <div className={`bg-white py-10 p-3 text-sky-700 rounded flex flex-col justify-center items-center ${title.className} max-w-[700px] mx-auto shadow-[15px_15px_0px_0px_rgba(0,0,0,.3)]` }>
                ...
                <div>
                    <div className=" w-full mb-[30px]">
                        <h3 className="tracking-[-2px] text-5xl font-bold"><span className="">Sobre mim</span></h3>
                    </div>
